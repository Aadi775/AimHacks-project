      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-surface-container-lowest rounded-3xl p-6 shadow-sm hover:shadow-md transition-all flex flex-col justify-between group">
          <div>
            ...
            <div className="mt-4"><h3 className="font-headline-md text-headline-md text-on-surface font-semibold">Hyperlocal Microclimates</h3><p className="font-body-sm text-body-sm text-on-surface-variant mt-1">Wide 12° thermal spread across 7 miles due to desert thermal gradients.</p></div>
            <div className="grid grid-cols-3 gap-2.5 mt-5">
              {[
                { name: 'C-Scheme', temp: '33°', cond: 'Clear', condColor: 'text-secondary', condIcon: 'wb_sunny' },
                { name: 'Malviya Nagar', temp: '35°', cond: 'Sunny', condColor: 'text-amber-500', condIcon: 'wb_sunny' },
                { name: 'Vaishali', temp: '34°', cond: 'Breezy', condColor: 'text-on-surface-variant', condIcon: 'air' },
              ].map((d) => (
            ...
            <div className="mt-5 p-3 rounded-2xl bg-surface-container-low/40 flex items-center justify-between">
              <div className="flex items-center gap-2.5"><span className="material-symbols-outlined text-[20px] text-secondary">explore</span><div className="min-w-0"><span className="font-label-xs text-label-xs text-on-surface-variant uppercase tracking-wider block">Aravalli Wind Vector</span><span className="font-body-sm text-body-sm text-on-surface font-medium block">WNW 14 mph • Gusting 21 mph</span></div></div>
          ...
          <div>
            ...
            <div className="space-y-2 mt-4">
              {[
                ...
                { agency: 'JCTSL', color: 'bg-secondary-fixed', textColor: 'text-on-secondary-container', line: 'AC1 / Route 9', status: '96% Cadence', statusColor: 'on-tertiary-container' },
              ].map((t) => (
